...
Providers are a fundamental part of workflows in KAS. They enable workflows to interact with external systems, fetch data, and execute actions. In this focused edition, providers are centered on the lightweight AIOps closed loop: Prometheus, Grafana Loki, OpenAI/DeepSeek/Ollama, Slack/SMTP/Webhook, GitHub/Jira, and HTTP/SSH/Bash/Python.
